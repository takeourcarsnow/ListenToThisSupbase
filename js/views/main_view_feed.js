  ...
  top.innerHTML = `
    <div class="toolbar topbar-toolbar">
      <div class="user-actions-container">
        <span class="notification-dot" id="mobile-notification-dot" style="position: static; cursor: pointer; display: inline-block; margin-left: 0px; margin-right: 0px; opacity: 0.35;" title="No notifications"></span>
